...
@param {String} signing_key Key to use for signing the data.

@param {String} encryption_key Key to use for encrypting the data and signature.
...
@param {String} decryption_key Key to use for decrypting the data and signature.

@param {String} verifying_key Key to use for verifying the signature.
